...
public class TiBoTlePanel extends SkinnableContainer{
    ...
    private var _tbPanel:TBPanel = new TBPanel();


    [Bindable(event="tbPanelChanged")]
    public function get tbPanel():TBPanel{
        return _tbPanel;
    }

    public function set tbPanel( value:TBPanel ):void{
        if( value != _tbPanel ){
            _tbPanel = value;
            dispatchEvent( new Event( "tbPanelChanged" ) );
        }
    }
